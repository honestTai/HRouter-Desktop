...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported privately to the HRouter maintainer through the contact methods on the [honestTai GitHub profile](https://github.com/honestTai). All complaints will be reviewed and investigated promptly and fairly.
...
辱骂、骚扰或其他不可接受的行为，可通过 [honestTai GitHub 主页](https://github.com/honestTai)提供的联系方式私下报告给 HRouter 维护者。所有投诉都将得到及时和公平的审查和调查。
